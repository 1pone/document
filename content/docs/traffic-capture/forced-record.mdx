...
2. You can select the **action.record** icon ![record button](../resource/recordicon.png). And the **Key**: "arex-force-record" and **Value**: "true" will be added in the request **Header**. Then select **Send** to record the request.
